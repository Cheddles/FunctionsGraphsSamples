...
//    }
//    if ((GraphLine.m<=0)&&(yLoc==max(point1.yLoc,point2.yLoc))){
//      vertOffset=-30;
//      horizOffset=20;
//      textAlign(LEFT, CENTER);
//    }
...
//      textAlign(RIGHT, CENTER);
//    }
    text("("+String.format("%.0f",xLoc)+","+String.format("%.0f",yLoc)+")",map(xLoc,xMin, xMax, 0, width)+horizOffset, map(yLoc,yMin, yMax, height,0)+vertOffset);
